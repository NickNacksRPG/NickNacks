...
<span style="color:rgb(192, 0, 0)">Most races have a racial language, but also know common.

All creatures are assumed to have a base speed of 30ft.</span>

Keep in mind a lot of the lore I use to describe races is used to differentiate a given race from the others. I personally don’t appreciate when elves are just long pretty people. I also make it to give people a starting point if they don't know how to roleplay or world build with a specific race.
...
<span style="color:rgb(103, 254, 120)">For example...</span>
...
The only exception to this is if the skill bonuses only apply to specific circumstances, such as a [[cyborg]]'s sentinel build.
## <span style="color:rgb(103, 254, 120)">Format</span>
