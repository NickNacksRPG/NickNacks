...
If you target a shadow with a piercing melee weapon, you can embed it in the surface and entangle the shadow on hit or with a successful poise break, replacing all other effects and losing access to the weapon. Projectiles like arrows require 3 hits. Shadows cannot remove the entangling items on their own.
## <span style="color:rgb(103, 254, 120)">Other Traits</span>

<span style="color:rgb(103, 254, 120)">Ability Scores</span> - [[STR]] +3, [[DEX]] +2, [[LUK]] +0, [[INT]] +0, [[WIS]] +0, [[CHA]] +0
<span style="color:rgb(103, 254, 120)">Languages</span> - All non-secret.
<span style="color:rgb(103, 254, 120)">Copy (Su)</span> [[Polymorph|poly, true]] - As a [[FRA]], a shadow can emit a very bright flash of light while gazing upon a specific creature within 30 ft. When it does so It adds this creature to its memory. It can choose to immediately transform into this creature as part of this action. The replication process is almost perfect, giving the shadow access to the creatures memories, skill proficiencies, personality traits, current clothing, appearance, size etc.

The shadow gains all of the [[+Races|race]] features of the creature it copies or all of the natural attacks (including multi attack options)/movement abilities if it is not a playable race. A shadow can "memorize" copies of 4 different creatures/objects (see offense traits). It can transform into one as a standard action, or revert to its true form as a free action.

When copying a creature, treat its [[+Disguise]] roll as 26.
<span style="color:rgb(103, 254, 120)">Speed</span> - Speed of copied creature. Can choose to enter a hybrid form, breaking its disguise to move at a 40 [[Land Speed]] or [[Climb]] speed
