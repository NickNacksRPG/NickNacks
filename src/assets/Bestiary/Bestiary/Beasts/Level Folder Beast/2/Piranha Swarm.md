...
| <span style="color:rgb(0, 176, 240)">Saves</span> | +4, +4, +3 |     |
<span style="color:rgb(0, 176, 240)">Poise Immunity</span> - Group enemies do not have [[poise]] and cannot be poise broken.
<span style="color:rgb(0, 176, 240)">Single Target Resistance</span> - [[Resistance]] to any damage that only affects a single creature, most common with [[attack roll]]s. Certain attacks like [[Base Special Attacks|cleave]] can ignore this resistance, but you can only attack the swarm with such moves.
...
<span style="color:rgb(247, 138, 255)">Baited</span> - While piranhas do attack living creatures, they prefer easier prey. If a fresh dead carcass is within range of their blood scent, piranhas will tear it to shreds before moving on. Medium or small creatures distract for one turn. Anything smaller only uses their movement. Anything larger than medium distracts for 1 more turn per size category.
