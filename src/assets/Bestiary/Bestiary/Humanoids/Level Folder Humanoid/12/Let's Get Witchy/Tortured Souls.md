...
| <span style="color:rgb(0, 176, 240)">Poise</span> | 35                          | [[DR]] 2 (+5 [[Power Pose\|PP]]) |
| <span style="color:rgb(0, 176, 240)">Saves</span> | Fort +12, Refl +14, Will +9 |                                  |
<span style="color:rgb(0, 176, 240)">Dash Dance</span> - In combat a falcaptain is persistently moving. At the end of its turn, it chooses an adjacent space. It is treated as though it occupies its current space, or the space it chose for all effects, whichever is more advantageous. To affect him with an ability, it must be able to reach/affect both spaces.

Falcaptain's movement while [[strafing]] is [[elusive]].
## <span style="color:rgb(192, 0, 0)">Offense Traits (DC 21)</span>

| <span style="color:rgb(192, 0, 0)">Unarmed (C)</span> | +12        | +4 [[Maneuver Versatility\|MV]] |
| ----------------------------------------------------- | ---------- | ------------------------------- |
|                                                       | 2d6+3 (10) |                                 |
...
<span style="color:rgb(192, 0, 0)">Special Attack: Stomp</span> - Special: This attack can only be used against an airborne, [[Fly|flying]] or a [[Knocked Down]] target.
Deal an extra 2d6 (7) crush damage and immediately send the target to the ground, knocking them down. This special attack recharges [[On-hit]] and can be used multiple times a turn. If the target was flying, they take [[fall damage]].
<span style="color:rgb(192, 0, 0)">Down Taunt</span> [[Healing]] - By spending a standard action to say his catch phrase, falcaptain can recharge all of his special attacks and gain 10 [[temp hp]]. If he successfully hits a creature with Falcon Punch, he can take an immediate action to down taunt, ending his turn.
## <span style="color:rgb(247, 138, 255)">Weaknesses/Deep Lore</span>

<span style="color:rgb(247, 138, 255)">Clipn't</span> - Falcaptain must use a special attack each round of combat. If he fails to do so and doesn’t down taunt, he is [[shaken]] 1. If this happens and he becomes shaken 4 or higher, he gains the [[Time Out]] condition until he rests.
...
<span style="color:rgb(103, 254, 120)">Languages</span> - Common, Sylvan
<span style="color:rgb(103, 254, 120)">Athleticism</span> - Falcaptain can jump twice each round as a free action, even combining them in midair.
