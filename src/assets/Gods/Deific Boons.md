...
| +2  | 10+2*(LvL)   |
| +3  | 11+3*(LvL)   |
By performing tasks that cater more closely to a specific god's desires, you can earn actively earn more GBP. As you advance in tiers the criteria for what grants additional GBP should also increase in difficulty.
The inverse is also true: If you act in such a way that your god disapproves, you can lose GBP. Such losses can often be recouped through forms of repentance. 

Here's another handy chart to help you determine what boons you have based on your wisdom at later levels.

| Wis | LV for T1 boon (10 GBP) | T2 (20) | T3 (30) | T4 (40) | T5 (50) |
| --- | ----------------------- | ------- | ------- | ------- | ------- |
| +1  | 1                       | 10      | -       | -       | -       |
| +2  | 1                       | 5       | 10      | -       | -       |
| +3  | 1                       | 3       | 7       | 10      | -       |
Not all gods are created equal. The older and more powerful a god is, the more boons they can offer. Level 12 characters that choose the [[Demigod]] [[Ascendance]] can only grant T1 boons, while ancient deities that everybody knows and respects like the [[Earth Mother]] can grant the highest tier boons. Some gods even have multiple boons that creatures can pick and choose from at certain tiers.

[[Frogg Saran]] doesn't play by the rules of the other deities. He is the only deity you can accrue GBP for if you have negative wisdom, and you can't gain GBP from him passively. See his page for more details.
# <span style="color:rgb(103, 254, 120)">GBP and Polytheism</span> 
