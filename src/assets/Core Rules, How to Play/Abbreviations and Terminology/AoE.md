...
Unfortunately, with a hex/square grid, getting some types of lines are hard to replicate with these simple lines. By "pattern" I mean when you want to have the line "jump" diagonally slightly. This could mean slightly adjusting the angle every 10, 15 or 30 feet. so you could hit both skeletons by making a line that jumps every 20 ft like this.
![[{75685A16-0054-49BA-9AAF-64F189D38C22}.png|475]]
Let's make things a little more complicated. You got [[Knocked Down]] so you cant move and your pesky teammate is in the way. Let's try again. In such a scenario, this could be a legal line, but you're only hitting one guy.
![[{48E252F4-DEE0-4D2B-BB36-CC28FC876D53}.png|386]]
This would also be legal...But your ally might not be too happy about it. Notice how the line moves in regular 10 ft intervals before each diagonal "jump."
![[{81A99A89-CBB0-4C4D-8350-11000D5854C4}.png|384]]
This however, would be an illegal line, even if it would maximize your damage and avoid hitting your teammate. It's two different lines, not one. Only rare spells let you decide the shape of your line like [[Fire Snake]].
![[{2B096B05-E656-4B11-8246-A098122460F8}.png|335]]