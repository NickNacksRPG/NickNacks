...
icon: 🥕
---
## <span style="color:rgb(103, 254, 120)">1 - Gardening</span>
Your body is host to a variety of plant life. You have wooden parts, blooming flowers, leafy hair, roots growing along your body or moss growing on your face. You add plant to your creature type(s).

Gain the following benefits...
- You are constantly under the effects [[vine whip]], you can use these vines to make a [[Multiattack]]
...
You have advantage on [[+Persuasion]] checks against plant creatures.
## <span style="color:rgb(103, 254, 120)">2 - Guerrilla Gardening</span>
You gain [[nourish]] as an [[innate technique]], but you can only use it while on someone else's property and you do not have their explicit permission to do so. You ignore the mana burn and recharge tags when using this ability.
## <span style="color:rgb(103, 254, 120)">2 - Veggie Talents</span>
Just as you cultivate plant life around you, the plant life on you also receives special treatment.
At level 2, 4, 6, 8 and 10 you can choose one of the following ways to enhance the vegetation that grows on your body.
## <span style="color:rgb(103, 254, 120)">4 - New Recruits (Sp)</span>
You are constantly under the effects of [[arboreal army]], but it lacks the [[Concentration]] tag. Their [[attack]] increases by 2. If you yourself are currently transformed into a tree, you can use arboreal army with your own tree body.

You can use this ability to perform any [[+Combat Maneuver|combat maneuvers]] instead of only [[bully]].
...
You can also cause inanimate plants to wither away and die at a similar speed, dehydrating and losing all color very quickly.

Simply by moving around you can cause the vegetation in the terrain to adjust to your needs as a free action. Branches move to allow you to effortlessly [[Climb]]. Grass grows to give you a place to [[Hide]]. Flowers bloom to accompany your approach etc. This ability can do anything that an inanimate plant could reasonably do, given time and cultivation, instantly.
