...
## <span style="color:rgb(103, 254, 120)">1 - Malefic Performance</span>
...
## <span style="color:rgb(103, 254, 120)">1 - Performance: Inspire Doom</span>
...
## <span style="color:rgb(103, 254, 120)">4 - Performance: Fascination</span> [[mind-affecting]]
Action: <span style="color:rgb(103, 254, 120)">Standard</span>
Enemies are [[fascinated]] (will negates). When used in combat, creatures get a new save at the end of each turn.
## <span style="color:rgb(103, 254, 120)">4 - Finale: Confounding Crescendo</span>
Enemies are confused until they get an "act normally result."
## <span style="color:rgb(103, 254, 120)">6 - Performance: Incite Violence (mind-affecting)</span>
...
## <span style="color:rgb(103, 254, 120)">8 - Performance: Dirge of Doom</span>
Action: <span style="color:rgb(103, 254, 120)">Standard</span>
Enemies are [[frightened]] (will negates).
## <span style="color:rgb(103, 254, 120)">11 - Boogie Time (recharge)</span>
The power of your music is too intense, and everybody must dance to it. Your enemies dance a little too hard and are [[stunned]] (will negates).
