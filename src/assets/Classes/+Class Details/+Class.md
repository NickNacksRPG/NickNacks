...
Odd levels are mostly dedicated to getting the next tier of techniques. As such, class features are usually sparse. If any are included, they are usually minor increases in power or they are flavorful inclusions. You also get a [[Feat Functionality|feat]] every odd level.

Most classes require selecting an [[Archetype]] at level 1, which grants more specific thematic abilities.