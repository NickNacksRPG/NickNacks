...
This can be removed with [[First Aid (P)|first aid]] or by washing a creature clean, such as by being submerged in water. Any effect that removes [[Venom]] can also remove toxic stacks.

You can deliver toxic to creatures without them noticing using [[+Sleight of Hand]] outside of combat. In such cases, the damage is delayed for a few moments for you to make some distance.
## <span style="color:rgb(103, 254, 120)">1 - Master Poisoner</span>
You gain [[Poison Jab]] as an innate technique.
