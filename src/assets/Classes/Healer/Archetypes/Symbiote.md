...
## <span style="color:rgb(103, 254, 120)">1 - Enhanced Arm</span>
...
You gain a natural attack that does 2d8 damage (crush, pierce or slash, chosen on character creation). You get a +2 bonus when using this attack, increased to +8 when using combat maneuvers.
## <span style="color:rgb(103, 254, 120)">1 - Infection</span>
...
You have +2 to attack with your enhanced arm against infected creatures.
Infection is removed automatically by any [[healing]] effect or by administering [[First Aid (P)|first aid]].
Allies you use Healing Touch on also get infected. Channel energy applies infection to all enemies and allies.
## <span style="color:rgb(103, 254, 120)">1 - Patient Zero (healing)</span>
...
## <span style="color:rgb(103, 254, 120)">1 - Rapid Growth</span> [[Healing]] [[Necrotic]] [[Recharge]]
...
## <span style="color:rgb(103, 254, 120)">2 - Organic Length</span>
...
## <span style="color:rgb(103, 254, 120)">4 - Swipe</span>
...
## <span style="color:rgb(103, 254, 120)">4 - Massive Shove</span>
Whenever you [[shove]] a creature, it is pushed to the edge of your reach in a straight line, then an additional 10 ft. Any other bonuses to shove distance also apply.
Creatures impacting terrain are staggered for 1 round (fort negates).
## <span style="color:rgb(103, 254, 120)">6 - Siphon</span> [[Persistent]] [[Concentration]]
Spend 3 mana to dig your enhanced arm into the ground and have it emerge in a space within reach. A 10 ft radius around this point is consumed by your organic growth, turning it into [[difficult terrain]], even to [[Hover|hovering]] creatures. Enemies that start their turn within this area or move into it take your enhanced arm damage.
...
## <span style="color:rgb(103, 254, 120)">10 - Congo Line</span>
Whenever you shove a creature, all creatures in a line behind them are shoved as well (reflex negates).
## <span style="color:rgb(103, 254, 120)">11 - Terminal</span>
Enemies are infected until the effect is removed manually.
Rapid growth doesn't end infections.
