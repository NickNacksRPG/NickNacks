...
Recharges after 1 minute or when you roll a natural 1.
## <span style="color:rgb(103, 254, 120)">2 - All Calculated</span>
...
## <span style="color:rgb(103, 254, 120)">2 - Escape Artistry</span>
You can escape manacles, vines, webs, rope, grapples and more using [[+Sleight of Hand]] instead of the usual method. If you would normally escape through [[+Athletics]], then use the athletics DC. If you are [[Grapple|grappled]], then roll sleight of hand opposed to the grappling creatures reflex save. If there is not predetermined action type for the effect, it is a standard action.
...
## <span style="color:rgb(103, 254, 120)">2 - Watch How It's Done</span> [[mana burn]]
When a creature you can see fails a skill check, you can spend 1 mana to "try it yourself." You automatically achieve their result and add your [[LUK]] to it. If you succeed, you remove the mana burn.
## <span style="color:rgb(103, 254, 120)">2 - Natural Order</span>
...
The DC is 20. The effect is usually to stir people up in public places, so without others present, this doesn’t do much. These events are usually temporary only lasting a few minutes.
## <span style="color:rgb(103, 254, 120)">2 - Fancy Meeting You Here (recharge)</span>
...
## <span style="color:rgb(103, 254, 120)">4 - Fortune Filch</span>
