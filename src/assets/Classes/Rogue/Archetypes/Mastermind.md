...
## <span style="color:rgb(103, 254, 120)">1 - Quick Thinking</span>
Gain a pool of D8 dice (1+1/2 [[LvL]]+[[INT]]) . These can be used on any [[DEX]] or [[STR]] [[ability check]] or [[skill check]], saving throw, or attack roll, even after learning the results of the check to make it succeed retroactively.
This ability cannot be used to exceed what would otherwise be the maximum result (such as 28 for d20+8).
## <span style="color:rgb(103, 254, 120)">1 - Shrodinger's Pockets</span> [[Sp]]
...
## <span style="color:rgb(103, 254, 120)">1 - Fast Hands</span>
...
## <span style="color:rgb(103, 254, 120)">2 - Professional Thief</span>
You may use Sleight of Hand in place of a [[+Profession]] skill of your choice (typically related to illegal or morally dubious activities, or businesses that tend to facilitate such). This ability counts as having the Profession skill for qualification purposes.
## <span style="color:rgb(103, 254, 120)">4 - Power Thief</span>
When you successfully hit a [[DD]] creature, you may use your Cunning Action to [[Dispel]] them (with a bonus equal to your [[LvL]]), targeting a [[buff]] or spell they have on themselves. If you succeed, you steal the buff for its remaining duration. If it was also [[concentration]], you begin concentrating on it.
## <span style="color:rgb(103, 254, 120)">6 - Wealth</span>
