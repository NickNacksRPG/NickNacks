...
* <span style="color:rgb(112, 48, 160)">The self </span>is related to [[CHA]], and represents an aspect of yourself that gets along with others. Things such as cooperation, empathizing and commanding others.
* <span style="color:rgb(255, 192, 0)">The body</span> is related to [[STR]]/[[DEX]], and represents an aspect of yourself that interacts with material reality. Repairing or breaking things, flexing on people and sleight of hand.
* <span style="color:rgb(192, 0, 0)">Instinct</span> is related to [[WIS]], and represents an aspect of yourself that can see the unseen. Things such as gut feelings and hunches.
* <span style="color:rgb(0, 176, 240)">Intellect</span> is related to [[INT]], and represents an aspect of yourself that knows information. Things such as logic, mathematics and knowledge.
As an instant action before you roll a skill check, spend 1 mana to add a d8 to it. If you fail the check, you [[Mana Burn]] 1. You cannot use this when you [[Taking 10|take 10]]/[[Taking 20|take 20]].
## <span style="color:rgb(103, 254, 120)">1 - Invoke Psyche</span> [[Mana Burn]]
The fragments of your mind have much to say, but they can be pushed even further beyond. You can choose to invoke a particular fragment of your psyche by having a brief conversation with it for a minute. Roll a d8 and add the key ability score (choosing between str or dex as appropriate for the situation for <span style="color:rgb(255, 192, 0)">the body</span>). If the final result totals 6 or higher, you learn a far greater amount of information that you otherwise would have, or succeed in some other superlative fashion. If you fail, you glean nothing.

<span style="color:rgb(192, 0, 0)"><i>For example</i></span> if you invoke <span style="color:rgb(112, 48, 160)">the self</span> during a war meeting to convince an enemy to agree to an armistice you might get something like...
...
<span style="color:rgb(192, 0, 0)"><i>Another example</i></span> if you invoke<span style="color:rgb(0, 176, 240)"> intellect</span> in order to detect any patterns in an ongoing investigation on some wanted criminal you might get something like...
...
## <span style="color:rgb(103, 254, 120)">2 - Invocations</span>
