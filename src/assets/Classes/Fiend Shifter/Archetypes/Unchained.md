...
## <span style="color:rgb(103, 254, 120)">1 - Return the Favor</span>
...
## <span style="color:rgb(103, 254, 120)">1 - Flesh Wound</span> [[healing]]
When you are [[Defeated]], you only become [[Drained]] 2. When recovering from being defeated, you are [[Staggered]] instead of [[Dazed]].

Whenever you take damage, keep a running tally of how much damage you have taken. After 1 minute of not taking damage, restore half of this value as hp.
## <span style="color:rgb(103, 254, 120)">1 - Masochism</span>
...
Whenever an enemy within 60 ft of you fails a skill check, fails to even graze with an attack or fails a saving throw, you restore 5 hp.
