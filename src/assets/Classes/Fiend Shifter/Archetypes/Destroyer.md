...
## <span style="color:rgb(103, 254, 120)">6 - Second Seal: Bloodlust (Su)</span>
...
## <span style="color:rgb(103, 254, 120)">11 - Final Seal: Monstrosity (Su)</span> [[fear]]
...
***
### <span style="color:rgb(103, 254, 120)">Fiendish Growths</span>
Numbers indicate level requirements (10 total)
## <span style="color:rgb(103, 254, 120)">1 - Terror to Behold</span>
You can [[demoralize]] creatures up to 60 ft away.
When you break the seal, you gain a +4 bonus to intimidation and can demoralize a creature as part of doing so.
You gain the [[fearsome finisher]] feat
## <span style="color:rgb(103, 254, 120)">1 - Cacophonous Clap</span> [[sonic]]
You gain the rend monster ability (2 claws). Deals 2d6 (7) sonic damage.

As a standard action, or at the end of a [[Core Rules, How to Play/Actions/Common Actions/Full Round Actions/Charge]], deal 2d8+lvl (9+lvl) sonic damage to all creatures within your natural reach and [[Staggered|stagger]] all creatures for one round (fort halves damage and negates stagger).
## <span style="color:rgb(103, 254, 120)">1 - Tongue</span>
...
Grasping Tongue: - Kidnap your foe. If the attack lands, make an additional [[drag]] attack.
## <span style="color:rgb(103, 254, 120)">2 - Taste Test (Su)</span>
...
## <span style="color:rgb(103, 254, 120)">4 - The Succ (sonic)</span> [[air]] 
...
## <span style="color:rgb(103, 254, 120)">10 - Endless Abyss (Su)</span>
...
## <span style="color:rgb(103, 254, 120)">10 - Eater of Souls (Su)</span> [[healing]] [[Teleportation]] [[overheal]]
