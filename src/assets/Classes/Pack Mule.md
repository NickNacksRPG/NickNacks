...
| [[Poise]]      | 20                 |
| [[Skills]]     | 4                  |
| [[+Saving Throw]]     | Fort, Refl, Will |
| [[Memory]]     | 4+(2*[[LvL]])              |


## <span style="color:rgb(103, 254, 120)">1 - Techniques</span>
You have [[Martial Specialization]]
You gain a [[technique point]] at level 1, and another every 2 levels after.
These points can be used on the [[Protector]] tree.
## <span style="color:rgb(103, 254, 120)">1 - Weenie</span>
This class fundamentally alters how many aspects of your character scales offensively. 
* Your [[DC]] is 7+LvL instead of 12+LvL (even when using [[Alchemical Items]] made by others)
* Whenever you deal [[+HP]] or [[Poise]] damage, that value is cut in half. This uniquely also affects [[True Damage]].
These effects are also applied to [[Companion|companions]].
...
- You get 10 additional [[Inventory|inventory slots]].
- [[+Athletics]] proficiency with a +4 bonus.
- +4 bonus to all [[STR]]-based [[Ability Check|ability checks]]
## <span style="color:rgb(103, 254, 120)">1 - Team Game</span>
- You can take the [[Carry]] action as a swift action. When you carry a [[defeated]] creature, they are protected from all harmful effects. 
...
The amount of gold you can invest in it is (1,000*[[LvL]])
## <span style="color:rgb(103, 254, 120)">2 - Action Surge</span> [[recharge]]
As a free action, gain a standard action.
Usable 1/minute.
## <span style="color:rgb(103, 254, 120)">2 - Versatility</span>
Gain a [[+Multiclass]] feat and the [[Signature Skill]] feat.
## <span style="color:rgb(103, 254, 120)">2 - Esoteric Knowledge (recharge)</span>
Once per game session you can roll any [[Skill Check]]. It ignores any bonuses you posses, such as from [[Ability Scores|Ability Score]]s, racial/class bonuses, or [[Skill Proficiency|skill proficiencies]]. You instead roll with a bonus of (2xLvL).
