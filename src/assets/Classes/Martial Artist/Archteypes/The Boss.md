...
## <span style="color:rgb(103, 254, 120)">2 - Now Kiss</span>
...
## <span style="color:rgb(103, 254, 120)">8 - Star KO</span>
If one of your [[Unarmed Attack|unarmed attacks]] [[Defeated|defeats]] a foe, you can choose to launch them d100 miles in a random direction. This does not cause them additional harm, only puts them far away from you, unless the location they land is inherently hazardous.
## <span style="color:rgb(103, 254, 120)">10 - Special Attack: Stratosphere Slam</span>
...
## <span style="color:rgb(103, 254, 120)">11 -  Special Attack: Showstopper</span>
You gain the wrestling move of the same name (see [[Wrestling Moves]] for more details). It can also be a finisher.
The initial target and creatures in the impact zone instead take 7d6+lvl (24+lvl) crush damage and are [[staggered]] for 1 round (fort halves damage and negates stagger).
