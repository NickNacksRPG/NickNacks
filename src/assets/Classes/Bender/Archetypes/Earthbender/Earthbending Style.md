...
## <span style="color:rgb(103, 254, 120)">1 - Versatile Blast</span>
Your elemental blast can deal pierce, crush and slash damage interchangeably.

You can use elemental blast to perform combat maneuvers from a range. All combat maneuvers you do with your blast get a +8 bonus.
## <span style="color:rgb(103, 254, 120)">1 - Dusty (1)</span> [[concentration]]
You permanently memorize the [[Fog Cloud]] technique, but it also gains the earth tag. By spending a standard action each turn, you can cause it to follow your movement, or the movement of another creature of your choosing within 30 ft.

You can also spend a standard action to increase its size, essentially adding another fog cloud adjacent to the first one.
## <span style="color:rgb(103, 254, 120)">1 - Shelter (1)</span>
As an immediate action, decrease the damage of an [[attack]] roll or [[AoE]] effect affecting you by your [[LvL]]. Can also be used to defend an ally touching the ground within 30 ft of you.
## <span style="color:rgb(103, 254, 120)">1 - Magnetism (concentration)</span>
...
## <span style="color:rgb(103, 254, 120)">1 - Boost</span>
...
At any point thereafter, you can close the fissure as a standard action, crushing anybody inside. They take your blast damage and are [[entombed]]. [[Breakout]] as a FRA (Class DC+5).
...
## <span style="color:rgb(103, 254, 120)">6 - Cannonball (3)</span>
By falling at least 20 ft and landing on the ground, you can cannonball as a standard action. Creatures within 20 ft of you take your blast damage and are clumsy 2 (reflex halves damage and clumsy).
This also negates your [[fall damage]].
## <span style="color:rgb(103, 254, 120)">6 - Favored Terrain (3)</span>
As a swift action, you can use earthbending to create terrain that lasts until the end of your turn, or until the end of your next turn. This can be used to make things like bridges, ramps and stairs or [[Total Cover]].
## <span style="color:rgb(103, 254, 120)">6 - Sinkhole (3) (concentration)</span>
Cause a creature within 30 ft to sink into the earth. They are entangled and take blast damage (fort halves damage and negates entangle). Breakout as a swift action to escape.

If the creature was already entangled, they are instead entombed and take blast damage (fort halves damage and negates entomb). Breakout (Class DC+5) to escape as a FRA.
## <span style="color:rgb(103, 254, 120)">6 - Earth Skating (3) (elusive)</span>
...
## <span style="color:rgb(103, 254, 120)">8 - Cuff 'em (4)</span> [[recharge]]
Use earth to bind a creature within 30 ft. Two of their arms (or similar limbs) become completely unusable and they drop whatever is in their hands (reflex reduces to one arm, their choice). Breakout as a swift action to break bindings.
...
If used outside of combat, the breakout DC to break the cuffs increases by 10.
Cannot be used in consecutive rounds.
## <span style="color:rgb(103, 254, 120)">10 - Earthquake (5) (recharge) (concentration)</span>
...
Lasts 3 rounds.
## <span style="color:rgb(103, 254, 120)">10 - Earthshaker (1)</span>
Whenever you move, you can choose to spend a swift action to stomp and shatter the ground in front of you. Deal ([[LvL]]) damage in a 15ft cone and [[Staggered|stagger]] enemies for 1 round (fort negates).
## <span style="color:rgb(103, 254, 120)">10 - Tip the Balance (5) (recharge)</span>
