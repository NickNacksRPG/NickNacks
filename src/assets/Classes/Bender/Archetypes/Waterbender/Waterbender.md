...
You can also use all waterbending based abilities using water adjacent substances, such as fruit juice, blood or perfume. This does not include liquids of other substances, such as acids, poisons, mercury, lava etc.
## <span style="color:rgb(103, 254, 120)">3 - Elemental Intuition: Freeze</span>
You can use your elemental blast to deal cold damage or crush damage interchangeably. In general, you can use water, even moisture in the air, to decrease the temperature of things, such as to freeze metal to make it more brittle.
## <span style="color:rgb(103, 254, 120)">5 - Elemental Intuition: Waterbending Adept</span>
You no longer need to concentrate in order to maintain structures created by water bending.

You can carry large quantities of water with you using waterbending in order to fuel your abilities. Doing so for longer than 10 minutes without resting for 1 minute inflicts [[Fatigued|fatigue]].
