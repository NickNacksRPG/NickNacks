...
## <span style="color:rgb(103, 254, 120)">1 - Money is Power</span> [[Su]]
The more decorated you are in your wealth, the more powerful you become. As long as you are covered in jewelry, fine clothing and other fancy mundane items worth at least (1000*[[LvL]]), your CL is increased by 1.

Whenever you take [[Damage]], you can choose to destroy (1000*[[LvL]]) worth of items in you are wearing in order to negate it as an immediate action. Gold pieces themselves cannot be destroyed using this.

# <span style="color:rgb(0, 176, 80)">Arcane Discoveries (Financial Wizardry)</span>

## <span style="color:rgb(103, 254, 120)">2 - Arcane Synergy</span>
...
## <span style="color:rgb(103, 254, 120)">2 - Bling</span>
Get an additional magic item slot that can be used for baubles.
